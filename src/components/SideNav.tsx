  ...
  return (
    <nav className="sticky top-0 self-start px-2 py-4">
      <ul className=" flex flex-col items-start gap-2 whitespace-nowrap">
          ...
          <Link href="/">
            <IconHoverEffect>
              <span className="flex items-center gap-4">
                ...
                <span className="hideen text-lg md:inline">Home</span>
              </span>
            </IconHoverEffect>
          </Link>
        </li>
        {user != null && (
          <li>
            <Link href={`/profiles/${user.id}`}><IconHoverEffect>
              <span className="flex items-center gap-4">
                <VscAccount className="h-8 w-8"/>
                <span className="hideen text-lg md:inline">Profile</span>
              </span>
          ...
          <li>
            <button onClick={() => void signIn()}><IconHoverEffect>
              <span className="flex items-center gap-4">
                ...
                <span className="hideen text-lg md:inline">Log In</span>
              </span>
            </IconHoverEffect>
            </button>
          </li>
          ...
          <li>
            <button onClick={() => void signOut()}><IconHoverEffect>
              <span className="flex items-center gap-4">
                ...
                <span className="hideen text-lg md:inline">Log Out</span>
              </span>
